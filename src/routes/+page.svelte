  ...
  <div class="lg:w-full">
    <div class="lg:max-w-2xl">
      ...
      <Alert color="yellow" class="mt-4">
        ...
        Due to the high demand of single users, this service is currently limited to ten requests per day. Please consider <a href="https://buymeacoffee.com/martinlowinski" target="_blank" class="underline underline-offset-4">donating</a> as my API costs increased by a factor of ~20 to keep this free.
      </Alert>
