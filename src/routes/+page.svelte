...
<div class="container mx-auto max-w-7xl my-20 flex flex-col gap-10 items-start md:my-20 lg:flex-row">
  ...
  <div class="sticky mt-2 flex w-[400px] flex-col px-8 md:top-36 md:mt-0 lg:max-w-2xl">
    <Mockup />
  </div>
</div>
